...
export declare const isStaffRegistrationApproved: (roleId: number) => boolean;
export declare const addHours: (numOfHours: any, date: Date) => Date;
export declare const round: (number: any) => number;
export declare const getHearRateTargetPercentage: (age: any, value: number) => number;
export declare const AESEncrypt: (value: any) => Promise<string>;
export declare const AESDecrypt: (value: any) => Promise<any>;
